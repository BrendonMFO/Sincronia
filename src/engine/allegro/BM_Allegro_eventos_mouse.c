...
// Variaveis
//==========================================================================
static BM_EVENTO_MOUSE_FILA *BM_Fila_eventos_mouse = NULL;

//==========================================================================
// Prototipos
//==========================================================================
static BM_EVENTO_MOUSE *BM_Eventos_procurar_fila_mouse(int _posicaoX, int _posicaoY, int _finalX, int _finalY);
